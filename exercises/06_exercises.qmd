...
\<\<\<\<\<\<\< HEAD This can be confusing at the beginning, but we will get used to it. ======= This can be confusing at the beginning, but we will get used to it. \>\>\>\>\>\>\> 8f6a9582fede535977e6295a0bdc9f3f8712e1dd
...
\<\<\<\<\<\<\< HEAD For both the Intercept and sigma, we'll have to define distributional parameters.
...
We'll start with a super agnostic prior for the mean: `uniform(0,1000)` assuming that any value between `0` and `1000` are equally probable and values outside of this range are impossible. \>\>\>\>\>\>\> 8f6a9582fede535977e6295a0bdc9f3f8712e1dd
For both the Intercept and sigma, we'll have to define distributional parameters.
...
\<\<\<\<\<\<\< HEAD We'll revisit the topic of priors again in later sections of this course. This might all feel very "subjective" and it actually is. Bayesian reasoning embraces the very fact that all decisions we as humans make a subjective to a large extent. But these beliefs can be more or less justified. ======= We'll revisit the topic of priors again in later sections of this course. This might all feel very "subjective" and it actually is. Bayesian reasoning embraces the very fact that all decisions we as humans make a subjective to a large extent. But these beliefs can be more or less justified.

> > > > > > > 8f6a9582fede535977e6295a0bdc9f3f8712e1dd
